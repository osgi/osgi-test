...
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.AFTER_AFTER_EACH;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.AFTER_ALL;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.AFTER_EACH;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.BEFORE_ALL;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.BEFORE_CLASS;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.BEFORE_EACH;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.INNER_TEST;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.NESTED_AFTER_EACH;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.NESTED_BEFORE_EACH;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.NESTED_TEST;
import static org.osgi.test.junit5.test.context.MultiLevelCleanupTest.CallbackPoint.PARAMETERIZED_TEST;
