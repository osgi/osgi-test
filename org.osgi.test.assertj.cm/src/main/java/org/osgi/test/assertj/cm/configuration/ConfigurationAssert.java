 ...
 */
public class ConfigurationAssert extends AbstractConfigurationAssert<ConfigurationAssert, Configuration> {

	/**
	 * Creates a new <code>{@link ConfigurationAssert}</code> to make assertions
	 ...
	 * <code>assertThat(myConfiguration)</code> and get specific assertion with
	 * code completion.
	 * 
	 * @param actual the Configuration we want to make assertions on.
	 * @return a new <code>{@link ConfigurationAssert}</code>
	 */
